...
%
% 3) thermalTomography: YOU CAN RUN THIS FUNCTION
%
% varargin:
%
...
Groove1 = Groove1(coord_Groove_ab(2,2):coord_Groove_ab(3,2),coord_Groove_ab(1,1):coord_Groove_ab(2,1));
...
if ax_mea == 0 %all
    Groove1 = mean(Groove1,2);
elseif ax_mea == 1 %only axis
    axis1 = round(size(Groove1,2)/2);
    Groove1 = Groove1(:,axis1);
end
...
Groove2 = Groove2(coord_Groove_bc(2,2):coord_Groove_bc(3,2),coord_Groove_bc(1,1):coord_Groove_bc(2,1));

if size(Groove2,2) > size(Groove2,1)
    Groove2 = Groove2';
end

if ax_mea == 0 %all
    Groove2 = mean(Groove2,2);
elseif ax_mea == 1 %only axis
    axis2 = round(size(Groove2,2)/2);
    Groove2 = Groove2(:,axis2);
end
...
Groove3 = Groove3(coord_Groove_ca(2,2):coord_Groove_ca(3,2),coord_Groove_ca(1,1):coord_Groove_ca(2,1));

if size(Groove3,2) > size(Groove3,1)
    Groove3 = Groove3';
end

if ax_mea == 0 %all
    Groove3 = mean(Groove3,2);
elseif ax_mea == 1 %only axis
    axis3 = round(size(Groove3,2)/2);
    Groove3 = Groove3(:,axis3);
end
