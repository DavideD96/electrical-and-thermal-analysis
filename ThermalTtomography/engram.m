function engram(filename,f_in,f_fin)
...
for ii = in:3:fin
    ...
    cd ..
    groove_coord = load([filename,zer,num2str(ii),'_groove_a-b_3-6_coordinates.mat']);
    groove_coord = groove_coord.groove1_coordinates;
    cd ..
