function plotRvsT_daTermo(delta_t, resistance, El_rs_, matriceEventi)
    resistance_events = [resistance, El_rs_(:, end-1)];
    [eventi_pos, eventi_neg] = cerca_evento_termo_005_noTypes_daTermo(matriceEventi, resistance_events, delta_t);
