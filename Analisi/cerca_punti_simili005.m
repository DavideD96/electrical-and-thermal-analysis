function [simili] = cerca_punti_simili005(Eventi, righe, colonne, frame_start, fr_diff, Eventi_RS_pos, Eventi_RS_neg)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            fname_succ = append("frame", num2str(frame_start+ j + fr_diff - 1));
             ...
             if Eventi_supp.(fname_succ).num_evento ~= 0
                ...
                if stato == 1
                    ...
                    stato_res = 0;
                    if  Eventi_supp.(fname_succ).massimi(1,1) >=  abs(Eventi_supp.(fname_succ).minimi(1,1))
                        for k = 1 : length(Eventi_RS_pos)
                    ...
                    elseif Eventi_supp.(fname_succ).massimi(1,1) <=  abs(Eventi_supp.(fname_succ).minimi(1,1))
                        for k = 1 : length(Eventi_RS_neg)
