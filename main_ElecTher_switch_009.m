...
[Th_rs, Eventi_Termo] = analisi_Nframes011_multiEvento_007(frame_start, 'makeVideo', 0);
size(Th_rs)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% plot results %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Th_rs
%renormalize times
...
%get y position
[max_peaks, min_peaks, Eventi_termo_ripuliti] = evento_max_temp_007(Th_rs_, Th_rs, Eventi_Termo, frame_start, fr_diff);
