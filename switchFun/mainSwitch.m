...
%
%Date: 2019-02-18 Last Modification: 2023-10-11
...
%
%   'nomefile': the name of the file where data are saved (usually 'Data.txt')
%   'folder': the name of the folder in the current directory where the
%             the file named 'nomefile' is to be found
