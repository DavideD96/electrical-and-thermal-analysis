function results_ordered = IntervalsAnalysis(T, R)
...
T = T - T(1,1);
    ...
    %---merge or not merge---
    answer = inputdlg({'Inserire i numeri corrispondenti agli intervalli da analizzare separatamente. Inserire il valore 0 per eseguire analisi su tutti gli intervalli insieme.'}); 
    n_choosen = str2num(answer{1});
    %disp(n_choosen);
