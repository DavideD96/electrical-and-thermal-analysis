function results= analisi_Nframes010(filename,Nframes, frame_start, fr_diff, coordname, soglia_max, soglia_min, method, varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 0 : Nframes - fr_diff
    ...
    %update data
    m_ausilio = m_memory(:,:,1:end-1); %tutta tranne l'ultima
    clear m_memory;

    m_ausilio = cat(3, m_ausilio, get_data002(filename, frame_start + i + fr_diff , coordname));
    m_memory = m_ausilio;
