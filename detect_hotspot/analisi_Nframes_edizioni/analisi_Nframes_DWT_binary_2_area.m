function [frames_states] = analisi_Nframes_DWT_binary_2_area(filename,Nframes, frame_start, fr_diff, coordname, soglia_max, soglia_min, varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Date: 2023-10-20 Last modification: 2023-10-20
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        %# create AVI object
        if video == 1
            video_name = [filename,'DETECT_fStart', num2str(frame_start), '_fdiff_', num2str(fr_diff), '_Nframes_', num2str(Nframes) ,'_DWT_binary_2'];
            ...
            for i=0:(Nframes-fr_diff)
                ...
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                %confronto del binary senza DWT
                % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
                %     if isempty(P.(fname){1,1}) == 0
                %         BW = imbinarize(mdiff, "global");
                %         subplot(3,3,8)
                %         imagesc(BW)
                %         set(subplot(3,3,8), 'YDir', 'normal')
                %         colormap(subplot(3,3,8),'gray')
                %         colorbar(subplot(3,3,8));
                %         title('Segmented image of hot regions without DWT');
                % 
                %     end
                % 
                %     if isempty(P.(fname){1,2}) == 0
                ...
                %         subplot(3,3,9)
                %         imagesc(BW)
                %         set(subplot(3,3,9), 'YDir', 'normal')
                %         colormap(subplot(3,3,9),'gray')
                %         colorbar(subplot(3,3,9));
                %         title('Segmented image of cold regions without DWT');
                %     end
                ...
                %se c'è un massimo lascio la matrice come è
                    if isempty(P.(fname){1,1}) == 0
                        ...
                        %binarizzo, pulisco l'immagine e stampo l'immagine originale con in sovrapposizione lo spot individuato 
