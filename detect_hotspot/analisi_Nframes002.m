function [framestates, area_arr] = analisi_Nframes002(filename,Nframes, frame_start, fr_diff, coordname, soglia_max, soglia_min, method, varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        for i=0:(Nframes-fr_diff)
            ...
            hold on
                ...
                if framestates(i+1, 5) ~= 0 && area == 1
                    [area_max, area_min, imsov] = calculate_area(D.(fname){1}, framestates(i+1,:), method_area, soglia_diff);
                    area_arr(i+1, :) = [area_max, area_min];
