function [max_evento, min_evento, area_max, area_min, imsov, n_puntoEvento] = detection_multiEvento_003_pV(max_hotspot, min_hotspot, point_state_max, point_state_min, imrec, mdiff, Rows, Columns)
