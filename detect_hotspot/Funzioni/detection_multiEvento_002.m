function [max_evento, min_evento, area_max, area_min, imsov] = detection_multiEvento_002(max_hotspot, min_hotspot, point_state_max, point_state_min, imrec, Rows, Columns)
    area_max = zeros(0,1);
    area_min = zeros(0,1);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
