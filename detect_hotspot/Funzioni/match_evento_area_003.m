...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
eventi_max = cell2mat(frame(2)); %matrice n-righe 2 colonne [coordinate, amplitudes]
eventi_min = cell2mat(frame(3));
...
if any(eventi_max(1,1)) %qualche evento (nuovo)?
