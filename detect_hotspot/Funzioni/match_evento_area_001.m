...
%
%   'frame' = struct containing info about event detection (time,
%           [max_coord amplitude], [min_coordinate amplitude], area_max, 
%           area_min, state)
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
eventi_max = frame.massimi; %matrice n-righe 2 colonne [coordinate, amplitudes]
eventi_min = frame.minimi; 
...
if eventi_max(1,1) ~= 0 
    ...
    i = 1;
    while i <= length(eventi_max(:,1)) && stato == 0 %ciclo sugli eventi 
...
if eventi_min(1,1) ~= 0 
    ...
    stato = 0;
    i = 1;
    while i <= length(eventi_min(:,1)) && stato == 0 %ciclo sugli eventi 
